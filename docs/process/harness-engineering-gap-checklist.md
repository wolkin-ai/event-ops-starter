...
6. Harden worktree enforcement and background review automation only when the team actually runs multiple agents in parallel.
...
- It does not enforce parallel worktree ownership by default.
